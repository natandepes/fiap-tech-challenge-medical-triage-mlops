...
exported to ONNX Runtime for the Stage 4 optimization — the API serves the ONNX build by default. A
heavy transformer would contradict the low-latency premise.
...
**Model only, in-process** — isolates the optimization:
